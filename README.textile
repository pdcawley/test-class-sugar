...
First, you'll need a bleeding edge
"Devel::Declare":http://github.com/rafl/devel-declare from Github, and you'll
also need to install the Test-Class.patch patch to your Test::Class
installation (at least until Adrian applies the patch and cuts a new
Test::Class). 

h2. Caution

The 'after' code fragment above doesn't quite work yet, but will do soon.
